...
public class WorkerDelete extends JFrame {
    ...
    public WorkerDelete() {
        ...
        picture.setIcon(new ImageIcon("picture/WorkerDelete.png"));
    ...
    public void MyEvent()
    {
        ...
        button_1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // TODO Auto-generated method stub
                String sql2 = "delete from worker_info where worker_id = '"+textField1.getText().trim()+"'";
                if(textField1.getText().equals(""))
                {
                    JOptionPane.showMessageDialog(null, "请输入要删除的员工工号！");
                }
                else
                {
                    Connection con = null;
